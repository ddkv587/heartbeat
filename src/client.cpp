...
bool verify_subject_alternative_name(const char * hostname, X509 * cert) {
	::std::cout << "verify_subject_alternative_name" << ::std::endl;
...
bool verify_common_name(char const * hostname, X509 * cert) {
	::std::cout << "verify_common_name" << ::std::endl;
	...
	::std::cout << "verify_common_name end " << hostname << " , " << common_name_str << ::std::endl;
 ...
 * http://www..org/doc/libs/1_61_0/doc/html/_asio/example/cpp03/ssl/client.cpp
 * and
 * https://github.com/iSECPartners/ssl-conservatory
 */
bool verify_certificate(const char * hostname, bool preverified, ::asio::ssl::verify_context& ctx) {
	::std::cout << "verify_certificate" << ::std::endl;
	...
	::std::cout << "verify_certificate end" << ::std::endl;
...
context_ptr on_tls_init(const char * hostname, websocketpp::connection_hdl) {
    ...
    try {
		...
		::std::cout << "on_tls_init end" << ::std::endl;
    } catch (std::exception& e) {
        std::cout << "verify error with" << e.what() << std::endl;
    }
    return ctx;
}
